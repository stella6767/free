...
export const base = {rootscrolllock,rootcolor,scrollbar,properties,rootscrollgutter,svg};
export const components = {drawer,link,stat,carousel,divider,mask,fieldset,dropdown,card,steps,alert,kbd,select,progress,fileinput,modal,footer,table,avatar,input,checkbox,badge,status,diff,hero,toggle,stack,navbar,label,menu,toast,button,list,mockup,calendar,indicator,rating,tab,filter,chat,radialprogress,countdown,tooltip,timeline,textarea,range,dock,breadcrumbs,radio,skeleton,loading,validator,collapse,swap};
