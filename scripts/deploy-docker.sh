...
sudo docker compose -f "$HOME/cicd/me/docker-compose-dev.yml" down
...
sudo docker compose -f "$HOME/cicd/me/docker-compose-dev.yml" build
...
sudo docker compose -f "$HOME/cicd/me/docker-compose-dev.yml" up -d
